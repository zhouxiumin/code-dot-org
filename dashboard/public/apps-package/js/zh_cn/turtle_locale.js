...
"blocksUsed":function(d){return "已经使用了的模块：%1"},
"branches":function(d){return "树枝"},
...
"createSnowflakeSquare":function(d){return "创建类型方形的雪花"},
"createSnowflakeParallelogram":function(d){return "创建类型平行四边形的雪花"},
...
"createSnowflakeFractal":function(d){return "创建类型分形的雪花"},
"createSnowflakeRandom":function(d){return "创建类型随机的雪花"},
...
"drawStamp":function(d){return "画邮票"},
...
"numBlocksNeeded":function(d){return "使用 %1 模块可以解决这个谜题。你使用了 %2。"},
"penDown":function(d){return "下移铅笔"},
"penTooltip":function(d){return "上下移动铅笔来启动或停止绘图。"},
"penUp":function(d){return "上移铅笔"},
"reinfFeedbackMsg":function(d){return "这里是您的绘图 ！继续做下去，或者继续到下一个谜。"},
"setAlpha":function(d){return "设置透明"},
"setColour":function(d){return "设置颜色"},
"setPattern":function(d){return "集的模式"},

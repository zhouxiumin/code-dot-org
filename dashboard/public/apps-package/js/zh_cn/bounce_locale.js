var bounce_locale = {lc:{"en":function(n){return n===1?"one":"other"},"bn":function(n){return n===1?"one":"other"},"ga":function(n){return n==1?"one":(n==2?"two":"other")},"zh":function(n){return "other"}},
...
"isWallTooltip":function(d){return "如果这里有一堵墙，返回true"},
"launchBall":function(d){return "推出新球"},
"launchBallTooltip":function(d){return "启动一个球开始发挥作用。"},
"makeYourOwn":function(d){return "制作自己的弹跳游戏"},
...
"setBackgroundHardcourt":function(d){return "设置坚硬的地板场景"},
"setBackgroundRetro":function(d){return "设置复古场景"},
"setBackgroundTooltip":function(d){return "设置背景图案"},
"setBallRandom":function(d){return "设置随机弹球"},
"setBallHardcourt":function(d){return "设置硬地场弹球"},
"setBallRetro":function(d){return "设置复古球\n"},
...
"setPaddleRandom":function(d){return "设置随机桨"},
"setPaddleHardcourt":function(d){return "设置拉桨"},
...
"whenBallInGoal":function(d){return "当进球得分"},
"whenBallInGoalTooltip":function(d){return "当进球得分时，执行下面的操作"},

...
"level12FailureMessage":function(d){return "一定要挖掘三個紅石礦。這關卡結合了你在建造房子以及使用\"如果\"程式積木以防止掉到岩漿等學到的語法技巧。\n"},
...
"level3FailureMessage":function(d){return "分別走到兩隻羊的身邊，使用\"修剪\"程式積木收集羊隻身上的羊毛。記得使用\"向左轉\"、\"向右轉\"等程式積木以到達羊隻身邊。"},
"level3TooFewBlocksMessage":function(d){return "試著使用更多的程式積木來收集羊毛。走到每一隻羊身旁然後使用\"修剪\"程式積木。"},

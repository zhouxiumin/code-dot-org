var bounce_locale = {lc:{"en":function(n){return n===1?"one":"other"},"bn":function(n){return n===1?"one":"other"},"ga":function(n){return n==1?"one":(n==2?"two":"other")},"ms":function(n){return "other"},"ta":function(n){return n===1?"one":"other"},"zh":function(n){return "other"},"ar":function(n){
  if (n === 0) {
    return 'zero';
  }
  if (n == 1) {

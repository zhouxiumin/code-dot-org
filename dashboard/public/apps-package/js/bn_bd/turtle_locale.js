var turtle_locale = {lc:{"en":function(n){return n===1?"one":"other"},"es":function(n){return n===1?"one":"other"},"ar":function(n){
  if (n === 0) {
    return 'zero';
  }
  if (n == 1) {
  ...
  return 'other';
},"zh":function(n){return "other"},"el":function(n){return n===1?"one":"other"},"et":function(n){return n===1?"one":"other"},"fa":function(n){return "other"},"ga":function(n){return n==1?"one":(n==2?"two":"other")},"gl":function(n){return n===1?"one":"other"},"hi":function(n){return n===0||n==1?"one":"other"},"hu":function(n){return "other"},"id":function(n){return "other"},"is":function(n){
  ...
  return 'other';
},"sq":function(n){return n===1?"one":"other"},"sv":function(n){return n===1?"one":"other"},"ta":function(n){return n===1?"one":"other"},"th":function(n){return "other"},"uk":function(n){
  if ((n % 10) == 1 && (n % 100) != 11) {
    return 'one';
  }
  if ((n % 10) >= 2 && (n % 10) <= 4 &&

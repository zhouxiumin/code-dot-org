var common_locale = {lc:{"en":function(n){return n===1?"one":"other"},"bn":function(n){return n===1?"one":"other"},"ga":function(n){return n==1?"one":(n==2?"two":"other")},"zh":function(n){return "other"},"ar":function(n){
  ...
  return 'other';
},"bg":function(n){return n===1?"one":"other"}},
...
"nextLevelTrophies":function(d){return "অভিনন্দন! আপনি চূড়ান্ত পর্যায়ে সম্পন্ন এবং জিতেছেন "+common_locale.p(d,"numTrophies",0,"bn",{"one":"a trophy","other":common_locale.n(d,"numTrophies")+" trophies"})+"।"},
...
"nextStageTrophies":function(d){return "অভিনন্দন! আপনি "+common_locale.v(d,"Stagename")+" সম্পন্ন করছেন এবং "+common_locale.p(d,"numTrophies",0,"bn",{"one":"ট্রফি","other":common_locale.n(d,"numTrophies")+" টি ট্রফি"})+" জিতেছেন।"},

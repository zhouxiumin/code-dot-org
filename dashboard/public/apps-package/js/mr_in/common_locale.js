...
"finalStageTrophies":function(d){return "Congratulations! You have completed the final stage and won "+common_locale.p(d,"numTrophies",0,"mr",{"one":"a trophy","other":common_locale.n(d,"numTrophies")+" trophies"})+"."},
...
"nextLevelTrophies":function(d){return "Congratulations! You completed Puzzle "+common_locale.v(d,"puzzleNumber")+" and won "+common_locale.p(d,"numTrophies",0,"mr",{"one":"a trophy","other":common_locale.n(d,"numTrophies")+" trophies"})+"."},
"nextPuzzle":function(d){return "Next Puzzle"},
"nextStage":function(d){return "Congratulations! You completed "+common_locale.v(d,"stageName")+"."},
"nextStageTrophies":function(d){return "Congratulations! You completed "+common_locale.v(d,"stageName")+" and won "+common_locale.p(d,"numTrophies",0,"mr",{"one":"a trophy","other":common_locale.n(d,"numTrophies")+" trophies"})+"."},
"numBlocksNeeded":function(d){return "Congratulations! You completed Puzzle "+common_locale.v(d,"puzzleNumber")+". (However, you could have used only "+common_locale.p(d,"numBlocks",0,"mr",{"one":"1 block","other":common_locale.n(d,"numBlocks")+" blocks"})+".)"},
"numLinesOfCodeWritten":function(d){return "You just wrote "+common_locale.p(d,"numLines",0,"mr",{"one":"1 line","other":common_locale.n(d,"numLines")+" lines"})+" of code!"},
...
"totalNumLinesOfCodeWritten":function(d){return "All-time total: "+common_locale.p(d,"numLines",0,"mr",{"one":"1 line","other":common_locale.n(d,"numLines")+" lines"})+" of code."},

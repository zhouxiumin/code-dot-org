var turtle_locale = {lc:{"en":function(n){return n===1?"one":"other"},"bn":function(n){return n===1?"one":"other"},"ga":function(n){return n==1?"one":(n==2?"two":"other")},"zh":function(n){return "other"},"ar":function(n){
  if (n === 0) {
    return 'zero';
  }
  if (n == 1) {
...
"createSnowflakeSpiral":function(d){return "créer un flocon de type spirale"},
...
"drawStamp":function(d){return "Tamponner"},
...
"lengthFeedback":function(d){return "C'est ce qu'il faut sauf pour les longueurs à parcourir."},
...
"notBlackColour":function(d){return "Vous devez dessiner avec une autre couleur que le noir pour résoudre cette énigme."},
...
"reinfFeedbackMsg":function(d){return "Voici votre dessin ! Continuez à travailler dessus, ou allez à la prochaine énigme."},
"setAlpha":function(d){return "définir alpha"},
"setColour":function(d){return "choisir la couleur"},
"setPattern":function(d){return "Définissez le modèle"},
...
"wrongColour":function(d){return "Votre image n'est pas de la bonne couleur. Pour cette énigme, elle doit être %1."}};
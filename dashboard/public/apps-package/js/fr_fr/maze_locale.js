var maze_locale = {lc:{"en":function(n){return n===1?"one":"other"},"bn":function(n){return n===1?"one":"other"},"ga":function(n){return n==1?"one":(n==2?"two":"other")},"zh":function(n){return "other"},"ar":function(n){
  if (n === 0) {
    return 'zero';
  }
  if (n == 1) {
...
"atHoneycomb":function(d){return "à la ruche"},
...
"honey":function(d){return "faire du miel"},
"honeyAvailable":function(d){return "miel"},
"honeyTooltip":function(d){return "Transformer le nectar en miel"},
"honeycombFullError":function(d){return "Il n'y a plus de place pour mettre du miel dans cette ruche."},
"ifCode":function(d){return "si"},
"ifInRepeatError":function(d){return "Vous avez besoin d'un bloc \"si\" à l'intérieur d'un bloc \"répéter\". Si vous rencontrez des difficultés, essayez à nouveau le niveau précédent pour voir comment cela fonctionnait."},
...
"ifFlowerTooltip":function(d){return "S'il y a une fleur/une ruche dans la direction indiquée, alors effectuer certaines actions."},
"ifOnlyFlowerTooltip":function(d){return "Si il y a une fleur dans la direction indiquée, alors effectuer certaines actions."},
"ifelseFlowerTooltip":function(d){return "S'il y a une fleur ou une ruche dans la direction indiquée, alors le premier bloc d'actions est exécuté. Sinon, on exécute le deuxième bloc d'actions."},
...
"moveSouthTooltip":function(d){return "Déplace-moi d'un espace vers le Sud."},
"moveTooltip":function(d){return "Déplace moi d'une case vers l'avant ou l'arrière"},
"moveWestTooltip":function(d){return "Déplace-moi d'une case vers l'Ouest."},
...
"notAtHoneycombError":function(d){return "Tu ne peux faire du miel que lorsque tu es à une ruche."},
...
"repeatCarefullyError":function(d){return "Pour résoudre cette énigme, pense à la suite d'instructions contenant deux déplacements et un changement de direction, que tu pourrais insérer dans le bloc « répéter ». Ce n'est pas grave de se tourner une fois de trop à la fin."},
...
"uncheckedCloudError":function(d){return "Vérifie bien tous les nuages pour voir s'ils cachent des fleurs ou des ruches."},

...
"completedWithoutRecommendedBlock":function(d){return "تهانينا! لقد أكملت اللغزو رقم"+common_locale.v(d,"puzzleNumber")+" (و ايضا يكمنك استخدام مكعب اخر حتي يكون الكود الخاص بك أقوى)"},
...
"dropletBlock_mathRandom_description":function(d){return "يُرجع رقم عشري عشوائي اكبر من او يساوي 0 و أقل من 1"},
...
"dropletBlock_randomNumber_param0":function(d){return "اقل رقم"},
"dropletBlock_randomNumber_param0_description":function(d){return "اقل رقم تم ارجاعه"},
"dropletBlock_randomNumber_param1":function(d){return "أكبر رقم"},
"dropletBlock_randomNumber_param1_description":function(d){return "اكبر رقم تم ارجاعه"},
...
"finalStage":function(d){return "تهانينا! لقد أكملت المرحلة النهائية."},
...
"missingRecommendedBlocksErrorMsg":function(d){return "اقترتبت من الوصول. حاول ان تجرب استخدام مكعب برمجي جديد لم تستخدمه من قبل."},
"missingRequiredBlocksErrorMsg":function(d){return "اقتربت من الوصول. يجب عليك استخدام مقطع برمجي جديد لم تستخدمه من قبل."},
...
"shareWarningsStoreData":function(d){return "هذا التطبيق بني في \"استوديو التعليمات البرمجية\" \"Code Studio stores \"الذي يقوم بتخزين البيانات التي يمكن عرضها بواسطة أي شخص في هذا الرابط المتاح للجميع ، كن حذراً إذا طلب منك وضع معلوماتك الشخصية."},
...
"tryBlocksBelowFeedback":function(d){return "حاول استخدام واحد من المكعبات البرمجية الموجودة بالأسفل:"},

...
"exampleErrorMessage":function(d){return "A función "+common_locale.v(d,"functionName")+" ten un ou máix exemplos que necesitan algún axuste. Asegúrate de que encaixan coa definición e resposta á pregunta."},
...
"finalStageTrophies":function(d){return "Parabéns! Completaches a etapa final e tes ganado "+common_locale.p(d,"numTrophies",0,"gl",{"one":"un trofeo","other":common_locale.n(d,"numTrophies")+" trofeos"})+"."},

var craft_locale = {lc:{"en":function(n){return n===1?"one":"other"},"bn":function(n){return n===1?"one":"other"},"ga":function(n){return n==1?"one":(n==2?"two":"other")},"zh":function(n){return "other"},"ar":function(n){
  if (n === 0) {
    return 'zero';
  }
  if (n == 1) {
...
"blockPlantCrop":function(d){return "plante muda"},
"blockShear":function(d){return "tosquie"},
"blockTillSoil":function(d){return "are o solo"},
...
"level11FailureMessage":function(d){return "Não se esqueça de colocar pedregulho adiante se houver lava. Isso lhe permitirá chegar até os recursos da mina em segurança."},
"level12FailureMessage":function(d){return "Minere ao menos 3 blocos de redstone. Esta atividade usa o que você aprendeu ao longo da construção da sua casa e a instrução \"se\" para evitar cair na lava."},
"level13FailureMessage":function(d){return "Coloque \"trilho\" ao longo do caminho de terra que conecta a porta de sua casa à borda do mapa."},
...
"level2FailureMessage":function(d){return "Para derrubar uma árvore, ande até seu tronco e use o comando \"destrua o bloco\"."},
"level2TooFewBlocksMessage":function(d){return "Tente usar mais comandos para derrubar a árvore. Ande até seu tronco e use o comando \"destrua o bloco\"."},
"level3FailureMessage":function(d){return "Para coletar lã de ambas as ovelhas, ande até cada uma delas e use o comando \"tosquie\". Lembre-se de usar comandos \"vire\" para alcançar a ovelha."},
"level3TooFewBlocksMessage":function(d){return "Tente usar mais comandos para coletar lã de ambas as ovelhas. Ande até cada uma delas e use o comando \"tosquie\"."},
"level4FailureMessage":function(d){return "Você deve usar o comando \"destrua o bloco\" em cada um dos três troncos de árvore."},
"level5FailureMessage":function(d){return "Posicione seus blocos no contorno de terra para construir uma parede. O comando rosa \"repita\" executará comandos posicionados em seu interior, como \"posicione o bloco\" e \"avance\"."},
"level6FailureMessage":function(d){return "Posicione blocos no contorno de terra da casa para concluir o desafio."},
"level7FailureMessage":function(d){return "Use o comando \"plante\" para colocar mudas em cada trecho do solo escuro arado."},
"level8FailureMessage":function(d){return "Se você tocar em um creeper ele vai explodir. Dê a volta nele e entre em sua casa."},
"level9FailureMessage":function(d){return "Não se esqueça de colocar pelo menos 2 tochas pra iluminar seu caminho E minerar pelo menos 2 unidades de carvão."},

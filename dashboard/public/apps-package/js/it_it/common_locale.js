...
"completedWithoutRecommendedBlock":function(d){return "Congratulazioni! Hai completato l'esercizio "+common_locale.v(d,"puzzleNumber")+". (Ma potresti usare un blocco diverso per ottenere un programma migliore.)"},

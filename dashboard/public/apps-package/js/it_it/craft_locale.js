...
"blockDestroyBlock":function(d){return "distruggi il blocco"},
...
"level1FailureMessage":function(d){return "Devi usare le istruzioni per raggiungere le pecore."},
"level1TooFewBlocksMessage":function(d){return "Prova ad usare più istruzioni per raggiungere le pecore."},
"level2FailureMessage":function(d){return "Per abbattere un albero, avvicinati al suo tronco e usa l'istruzione \"distruggi il blocco\"."},
"level2TooFewBlocksMessage":function(d){return "Per abbattere un albero, prova ad usare più istruzioni. Avvicinati al suo tronco e usa l'istruzione \"distruggi il blocco\"."},
...
"level4FailureMessage":function(d){return "Devi usare l'istruzione \"distruggi il blocco\" su ciascun tronco d'albero."},

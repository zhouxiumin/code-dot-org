var flappy_locale = {lc:{"en":function(n){return n===1?"one":"other"},"bn":function(n){return n===1?"one":"other"},"ga":function(n){return n==1?"one":(n==2?"two":"other")},"zh":function(n){return "other"},"ar":function(n){
  if (n === 0) {
    return 'zero';
  }
  if (n == 1) {
...
"endGame":function(d){return "o'yin oxiri"},
"endGameTooltip":function(d){return "O'yinni tugatish"},
"finalLevel":function(d){return "Congratulations! You have solved the final puzzle."},
"flap":function(d){return "qanot qoqmoq"},
"flapRandom":function(d){return "flap a random amount"},
"flapVerySmall":function(d){return "kuchsiz qanot qoqish"},
"flapSmall":function(d){return "kuchsiz qanot qoqmoq"},
"flapNormal":function(d){return "normal miqdorda qanot qoqmoq"},
"flapLarge":function(d){return "katta kuch bilan qanot qoqmoq"},
...
"incrementPlayerScore":function(d){return "ochko to'plash"},
...
"playSoundBounce":function(d){return "ovoz ortishini ijro etish"},
"playSoundCrunch":function(d){return "play crunch sound"},
"playSoundDie":function(d){return "qayg'uli ovozni ijro etish"},
...
"playSoundWing":function(d){return "qanot ovozini ijro etish"},
"playSoundJet":function(d){return "samolyot ovozini ijro etish"},
"playSoundCrash":function(d){return "sinish ovozini ijro etish"},
"playSoundJingle":function(d){return "qo'ng'iroq ovozini ijro etish"},
"playSoundSplash":function(d){return "sachratish ovozini ijro etish"},
...
"scoreText":function(d){return "Hisob: "+flappy_locale.v(d,"playerScore")},
"setBackground":function(d){return "sahnani joylashtirish"},
"setBackgroundRandom":function(d){return "sahnani taxminan joylashtirish"},
"setBackgroundFlappy":function(d){return "shahar (kun) sahnasini joylashtirish"},
"setBackgroundNight":function(d){return "shahar (tun) sahnasini joylashtirish"},
...
"soundRandom":function(d){return "tasodifiy"},

...
"and":function(d){return "bilan"},
"backToPreviousLevel":function(d){return "Avvalgi bosqichga qayting"},
"blocklyMessage":function(d){return "Blokli"},
"blocks":function(d){return "bloklar"},
"booleanFalse":function(d){return "yolgʻon"},
"booleanTrue":function(d){return "rost"},
"catActions":function(d){return "Harakatlar"},
"catColour":function(d){return "Rang"},
"catLists":function(d){return "Ro‘yxatlar"},
"catLogic":function(d){return "Mantiq"},
"catLoops":function(d){return "Sikllar"},
...
"codeTooltip":function(d){return "JavaScriptda yaratilgan kodni ko‘ring."},
...
"designMode":function(d){return "Loyihalash"},
"dialogCancel":function(d){return "Bekor qilish"},
"dialogOK":function(d){return "Davom etish"},
...
"repeat":function(d){return "takrorlash"},
...
"submit":function(d){return "Tasdiqlash"},

...
"tooManyBlocksFail":function(d){return "Puzzle "+craft_locale.v(d,"puzzleNumber")+" completed. Congratulations! It is also possible to complete it with "+craft_locale.p(d,"numBlocks",0,"ga",{"one":"1 block","other":craft_locale.n(d,"numBlocks")+" blocks"})+"."}};
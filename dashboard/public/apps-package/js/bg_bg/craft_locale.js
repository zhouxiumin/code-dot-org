...
"blockPlaceXAheadPlace":function(d){return "поставям"},
"blockPlaceXPlace":function(d){return "поставям"},
...
"blockTypeOreEmerald":function(d){return "изомруди"},
...
"houseSelectChooseFloorPlan":function(d){return "Изберете план на етажите за къщата си."},
...
"level5FailureMessage":function(d){return "Поставете блоковете върху очертаният план, за да построите стена. Розовата команда \"повтори\" ще изпълни всички команди, вмъкнати в блока ѝ, като \"постави блок\" и \"върви напред\"."},
"level6FailureMessage":function(d){return "Поставете блокове върху очертаният план за къща, за да завършите пъзела."},
"level7FailureMessage":function(d){return "Използвайте командата \"засаждам\", за да поставите посеви в разораната земя."},
"level8FailureMessage":function(d){return "Ако докоснете пълзящо растение, то ще експлодира. Промъкнете се около тях, за да влезете във вашата къща."},

  ...
  task :run_ui_tests do
    if GitUtils.circle_commit_contains?(RUN_UI_TESTS_TAG)
      ...
      Dir.chdir('dashboard/test/ui') do
        RakeUtils.system_stream_output 'bundle exec ./runner.rb -c ChromeLatestWin7 -p localhost.code.org:3000 -d localhost.studio.code.org:3000 --circle --parallel 15 --magic_retry --html'
      end
    else

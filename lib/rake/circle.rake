...
namespace :circle do
  ...
  task :run_ui_tests do
    ...
    Dir.chdir('dashboard/test/ui') do
      ...
      RakeUtils.system_stream_output 'bundle exec ./runner.rb -c ChromeLatestWin7,Firefox45Win7,IE11Win10,SafariYosemite -p localhost.code.org:3000 -d localhost.studio.code.org:3000 --circle --parallel 50 --retry_count 3 --html'
      RakeUtils.system_stream_output "bundle exec ./runner.rb --eyes -f #{eyes_features.join(',')} -c ChromeLatestWin7,iPhone -p localhost.code.org:3000 -d localhost.studio.code.org:3000 --circle --parallel 50 --retry_count 3 --html"
    end
  end
end
